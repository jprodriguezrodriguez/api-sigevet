...
namespace sigevet.Migrations
{
    ...
    [Migration("20260415012016_FixRequiredCollections")]
    partial class FixRequiredCollections
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("sigevet.Models.Veterinario", b =>
                {
                    ...
                    b.Property<int>("estadoVeterinarioidEstado")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("estadoVeterinarioidEstado");
            ...
            modelBuilder.Entity("sigevet.Models.Veterinario", b =>
                {
                    ...
                    b.HasOne("sigevet.Models.Estado", "estadoVeterinario")
                        .WithMany()
                        .HasForeignKey("estadoVeterinarioidEstado")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
